...
use crate::{ArcStorage, BoxStorage, IdentStr, Policy, QuoteStyle, RcStorage, Storage};
...
///
/// let borrowed: IdentStr = IdentStr::new("\"Users\"");
/// let owned: IdentStr = IdentStr::new(String::from("\"Users\""));
///
/// assert_eq!(borrowed, owned);
/// ```
pub trait Input<S: Storage>: sealed::Sealed {
    #[doc(hidden)]
    fn into_unquoted<Q: QuoteStyle, P: Policy>(self, quote: Option<Q>) -> IdentStr<Q, P, S>;

    #[doc(hidden)]
    fn into_source<Q: QuoteStyle, P: Policy>(self) -> IdentStr<Q, P, S>;
}
...
impl Input<BoxStorage> for Box<str> {
    #[inline]
    fn into_unquoted<Q: QuoteStyle, P: Policy>(
        self,
        quote: Option<Q>,
    ) -> IdentStr<Q, P, BoxStorage> {
        IdentStr::from_owned(self, quote)
    }

    #[inline]
    fn into_source<Q: QuoteStyle, P: Policy>(self) -> IdentStr<Q, P, BoxStorage> {
...
impl Input<ArcStorage> for Arc<str> {
    ...
    fn into_unquoted<Q: QuoteStyle, P: Policy>(
        self,
        quote: Option<Q>,
    ) -> IdentStr<Q, P, ArcStorage> {
        IdentStr::from_owned(self, quote)
    }

    #[inline]
    fn into_source<Q: QuoteStyle, P: Policy>(self) -> IdentStr<Q, P, ArcStorage> {
        IdentStr::from_source_owned(self)
    }
}
...
impl Input<RcStorage> for Rc<str> {
    ...
    fn into_unquoted<Q: QuoteStyle, P: Policy>(
        self,
        quote: Option<Q>,
    ) -> IdentStr<Q, P, RcStorage> {
        IdentStr::from_owned(self, quote)
    }

    #[inline]
    fn into_source<Q: QuoteStyle, P: Policy>(self) -> IdentStr<Q, P, RcStorage> {
        IdentStr::from_source_owned(self)
    }
}
